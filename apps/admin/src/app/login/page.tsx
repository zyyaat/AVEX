...
import { Settings, Phone, Lock, Loader2, ArrowLeft, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="min-h-dvh bg-white flex flex-col" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 -mt-10">
        ...
        <h1 className="text-2xl font-bold mb-1">AVEX Admin</h1>
        <p className="text-sm text-gray-500 mb-8">لوحة الإدارة — للمديرين فقط</p>
        ...
        <div className="mt-8 text-center text-xs text-gray-400">
          <p>حساب تجريبي: 01000000000 / admin123</p>
        </div>
      </div>
    </div>
  )
